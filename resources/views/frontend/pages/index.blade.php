  ...
  <div class="top-body pt-4 pb-4">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="card card-body single-top-link" onclick="location.href='{{route('usr_login')}}'">
            <h4>Sign In</h4>
        ...
        <div class="col-md-3">
          <div class="card card-body single-top-link" onclick="location.href='{{route('user_signup')}}'">
            <h4>Create New</h4>
            ...
            @foreach($allBooks as $book)
              ...
              <div class="single-book">
                ...
                <div class="book-short-info">
                  ...
                  <p>
                    <a target="_blank" href="http://localhost/Booksharing/public/{{$book->pdf_upload}}"><i class="fa fa-upload"></i> {{$book->usr_name}}</a>"
                  </p>
                  <a href="{{ route('books.show') }}" class="btn btn-outline-primary"><i class="fa fa-eye"></i> View</a>
                  <a href="" class="btn btn-outline-danger"><i class="fa fa-heart"></i> Wishlist</a>
